...
import type { GauchoMode, GauchoRoomConfig, GauchoRoomSummary } from '../../../shared/types'

interface Props {
  rooms: GauchoRoomSummary[]
  onCreateRoom: (roomName: string, config: GauchoRoomConfig) => void
  onJoinRoom: (roomId: string) => void
}

const MODE_LABEL: Record<GauchoMode, string> = { '1x1': '1x1', '2x2': '2x2 (duplas)' }

export function GauchoLobby({ rooms, onCreateRoom, onJoinRoom }: Props) {
  const [showCreate, setShowCreate] = useState(false)
  const [roomName, setRoomName]     = useState('')
  const [mode, setMode]             = useState<GauchoMode>('2x2')
    ...
    <>
      ...
      {showCreate && (
        <div className="modal-overlay" onClick={(e) => e.target === e.currentTarget && setShowCreate(false)}>
          <div className="modal">
            <h2>Criar mesa de Truco Gaúcho</h2>
            ...
            <div className="field">
              ...
              <input
                ...
                placeholder="Ex: Mesa dos Gaúchos"
                maxLength={40}
              />
            </div>
            ...
            <div className="field">
              ...
              <span className="hint">Manilhas fixas: A♠ · A♣ · 7♠ · 7♦ — sem vira, com Envido e Flor.</span>
            </div>
